...
router.post("/send-project-dropdown-brachure-data", sendProjectDropdownBrachureData);
router.get("/get-project-dropdown-brachure-data",authMiddleware, getProjectDropdownBrachureData);
